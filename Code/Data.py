...
file1_path = r"../dataset/cleveland.data"
file2_path = r"../dataset/processed.cleveland.data"
...
os.makedirs("../ReadData/dataset", exist_ok=True)

# Xuất ra Excel với hai sheet
excel_path = r"../ReadData/dataset/heart_disease_data.xlsx"
